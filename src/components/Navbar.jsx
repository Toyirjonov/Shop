...
function Navbar() {
  ...
  const { basket, theme, dispatch, user, userData } = useContext(GlobalContext);
  ...
  const handleSearchSubmit = (e) => {
    e.preventDefault();
    window.globalSearchQuery = searchQuery.trim();
    if (window.updateSearchResults) {
      window.updateSearchResults(searchQuery.trim());
    }
  };
  ...
  const handleSearchChange = (e) => {
    ...
    window.globalSearchQuery = value.trim();
    if (window.updateSearchResults) {
      window.updateSearchResults(value.trim());
    }
  };
        ...
        <div className="flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2">
            <svg
              ...
              alt="Uzum"
              className="ui-icon  logo"
            >
              <rect width="32" height="32" rx="15.9882" fill="#FFFF00"></rect>
              <path
          ...
          <div className="flex-1 max-w-2xl mx-8">
            <form onSubmit={handleSearchSubmit} className="relative">
              <FiSearch className="absolute left-4 top-1/2 transform -translate-y-1/2 text-black" />
              <input
                type="text"
                value={searchQuery}
                onChange={handleSearchChange}
                placeholder="search"
                className="w-full pl-12 pr-12 py-3 bg-gray-100 text-black rounded-xl border-none focus:outline-none focus:ring-2 focus:ring-purple-500"
              />
              {searchQuery && (
                <button
                  type="button"
          ...
          <div className="flex items-center gap-6">
            <button className="flex flex-col items-center gap-1 relative">
              ...
              <span className="text-xs text-gray-600">Yaqtirganlarim</span>
              {favoritesCount > 0 && (
            ...
            <Link to="/basket" className="indicator">
              ...
              <button>
                <FaShoppingCart className="btn text-3xl" />
              </button>
            </Link>
            ...
            <label className="swap swap-rotate">
              ...
              <FaSun className="swap-on h-8 w-8 fill-current" />
            ...
            {user ? (
              ...
              <Link to="/login" className="flex flex-col items-center gap-1">
                ...
                <span className="text-xs text-gray-600">Kirish</span>
              </Link>
            )}
          </div>
        </div>
