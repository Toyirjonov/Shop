...
function SingleProduct() {
  ...
  const handleAddToCart = () => {
    ...
    window.globalCartCount = (window.globalCartCount || 0) + quantity;
    if (window.updateCartCount) {
      window.updateCartCount(window.globalCartCount);
    }
    ...
    console.log("Глобальный счетчик корзины:", window.globalCartCount);
    alert(
          ...
          <div className="bg-white rounded-2xl p-8">
            ...
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="text-gray-600">
                {product.rating} ({product.reviews.length} ta sharh)
              </span>
            </div>
